...
ARG VITE_ACCOUNTING_API_BASE_URL=https://136.68.89.25.nip.io/api/v2
...
RUN printf "VITE_ACCOUNT_API_BASE_URL=%s\nVITE_PARTY_API_BASE_URL=%s\nVITE_ACCOUNTING_API_BASE_URL=%s\nVITE_SWITCH_API_BASE_URL=%s\nVITE_IDENTITY_PLATFORM_API_KEY=%s\nVITE_APIGEE_API_KEY=%s\nVITE_API_TIMEOUT=%s\n" \
    "$VITE_ACCOUNT_API_BASE_URL" "$VITE_PARTY_API_BASE_URL" "$VITE_ACCOUNTING_API_BASE_URL" "$VITE_SWITCH_API_BASE_URL" "$VITE_IDENTITY_PLATFORM_API_KEY" "$VITE_APIGEE_API_KEY" "$VITE_API_TIMEOUT" \
